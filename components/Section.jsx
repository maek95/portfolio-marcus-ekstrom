export default function Section({ title, bgcolor, darkbgcolor, children, whitegradient, graygradient, gradient, className }) {
  return (
    <div
      id={title}
      className={`min-h-96 px-6 pt-5 pb-10 bg-${bgcolor} dark:bg-${darkbgcolor} bg-${gradient} ${className ? className : ""}`}
