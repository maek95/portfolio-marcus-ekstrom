...
export default function ScrollToTopButton() {
  ...
  return (
    <div>
    <button
      className={`z-50 flex justify-center items-center fixed bottom-28 right-5 md:right-20 w-12 h-12 p-4 cursor-pointer border-none rounded-lg shadow-md bg-[#347FC1] hover:bg-[#3f97e4] text-white ${isVisible ? 'opacity-100' : 'opacity-0'} ${isAtBottom ? 'bottom-48' : 'bottom-28'}`} /* transition duration-500 ease-in-out */
