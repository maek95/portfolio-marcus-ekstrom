...
export default function Hero() {
  ...
  return (
    <div className="h-lvh flex justify-center items-center min-w-full bg-white-gradient dark:bg-dark-gradient" //see tailwind.config.js, I added these custom gradients there!
    /* style={{
