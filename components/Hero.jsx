...
export default function Hero() {
  ...
  return ( //(removed) mt-[-80px] due to Header being 80px... // h-dvh with for dynamic view when e.g mobile browser footer or header impacts the screen size. Makes stuff jump around though - maybe test transition-all duration-500 ease-in-out
    <div className={`${isHeroInView ? "h-dvh" : "h-lvh"} transition-all duration-500 ease-in-out  flex justify-center items-center min-w-full bg-white-gray-gradient dark:bg-dark-gradient`} //see tailwind.config.js, I added these custom gradients there!
    /* style={{
